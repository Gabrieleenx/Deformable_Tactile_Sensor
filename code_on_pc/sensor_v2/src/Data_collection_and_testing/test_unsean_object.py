...
def main():
    ...
    if probe_bool:
        ...
        target_ruler = probe_utility.TargetShape(name="ruler", x_min=0.03, x_max=0.07, y_min=-0.03, y_max=0.03, max_z_delta=0.006, max_xy_delta=0.003, max_tz_delta=0.3, max_txy_delta=0.1, f_max=15.0, t_max=0.6)
        ...
        for target_obj in target_objects: 
            ...
            for i in range(nr_pokes):
                ...
                if rospy.is_shutdown(): 
                    break
                pose_in_contact = probe.go_to_height(target_obj, pose_, obj_pose_stamped.pose, start_height, pub_desired, 2.0)
                rospy.sleep(3.0)
